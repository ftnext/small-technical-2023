:og:description: XP祭り2023 ワークショップ、FizzBuzzを小さいテスト駆動開発で開発します

.. meta::
  :description: XP祭り2023 ワークショップ、FizzBuzzを小さいテスト駆動開発で開発します
...
.. include:: tdd/introduction.rst.txt

.. include:: tdd/environment.rst.txt

.. include:: tdd/examples.rst.txt

.. include:: tdd/future.rst.txt
...
* `読書ログ | 『Clean Craftsmanship』 第2章より、Uncle Bobのテスト駆動開発は驚くほど小さなステップの積み重ね！ <https://nikkie-ftnext.hatenablog.com/entry/clean-craftsmanship-small-small-test-driven-development-introduction>`__

  * 写経 https://github.com/ftnext/road-to-craft-skills-py/tree/main/int-stack
